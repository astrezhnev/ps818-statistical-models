...
- How do we figure out the partitions for a given tree?
  - (1): Pick some variable $j$ out of the set of available predictors
  - (2): Find a splitting point that minimizes the **within-partition** variance
  - (3): Repeat for another variable $j^\prime$ in each of the resulting regions
