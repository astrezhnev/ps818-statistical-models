...
```{r}
polls2012 <- read_csv("data/national_polls_2012.csv")
```


# Dynamic Binomial Model

- This is a **much simpler** version of the full state-and-national polling model used by The Economist (and now [FiftyPlusOne](https://fiftyplusone.news/))
  ...
  - Also check out the [old Github repository](https://github.com/TheEconomist/us-potus-model) for the actual model and Stan code!
